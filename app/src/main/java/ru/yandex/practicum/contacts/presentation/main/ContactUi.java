...
public class ContactUi implements ListDiffInterface<ContactUi> { //добавили реализацию интерфейса
    ...
    @Override
    public boolean theSameAs(ContactUi object){  //реализация метода
